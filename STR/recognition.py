...
class Recognition(Resource):
    def get(self):
        ...
        parser.add_argument('--image_folder', type = str, default='detection_result/', help='path to image_folder which contains text images')
        parser.add_argument('--workers', type=int, help='number of data loading workers', default=4)
        parser.add_argument('--batch_size', type=int, default=192, help='input batch size')
        parser.add_argument('--saved_model', type = str, default='STR/best_accuracy.pth', help="path to saved_model to evaluation")
        """ Data processing """
        ...
        with torch.no_grad():
            for image_tensors, image_path_list in demo_loader:
                ...
                log = open(f'flask_upload/ocr_result.txt', 'a')
                ...
                # detection_result내 파일 삭제
                for file in os.scandir(opt.image_folder):
                    os.remove(file.path)

                # return 'OCR END'
                return redirect('/searchDB') 
